...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  newCardTexture.repeat.set(1, 1);
  newCardTexture.offset.set(-0.2, 0);

  useEffect(() => {
    // Store original properties
    const originalMap = materials.base.map;
    const originalMetalness = materials.base.metalness;
    const originalRoughness = materials.base.roughness;
    const originalClearcoat = materials.base.clearcoat;

    // Apply new properties
    materials.base.map = newCardTexture;
    materials.base.metalness = 0;
    materials.base.roughness = 1;
    materials.base.clearcoat = 0;

    // Return cleanup function
    return () => {
      materials.base.map = originalMap;
      materials.base.metalness = originalMetalness;
      materials.base.roughness = originalRoughness;
      materials.base.clearcoat = originalClearcoat;
    };
  }, [materials.base, newCardTexture]);
